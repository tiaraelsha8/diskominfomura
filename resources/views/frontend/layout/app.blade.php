...
<head>
    ...
    <meta name="description"
        content="Situs Resmi Disdukcapil Kabupaten Murung Raya. Temukan informasi layanan, berita, pengumuman dan profil Disdukcapil.">
    ...
    <style>
        ...
        .navbar {
            ...
            padding: 1.5rem 0;
            font-size: 1.1rem;
            background-color: rgb(47 168 211 / 80%);
