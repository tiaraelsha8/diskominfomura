...
<head>
    <meta charset="UTF-8">
    <title>Kecamatan Murung - PEMERINTAH KABUPATEN MURUNG RAYA</title>
    ...
    <meta name="description"
        content="Situs Resmi Kecamatan Murung Kabupaten Murung Raya. Temukan informasi layanan, berita, pengumuman dan profil Kecamatan Murung.">
    <meta name="robots" content="index, follow"> <!-- biarkan Google mengindeks -->
    <link rel="canonical" href="https://kec-murung.murungrayakab.go.id"> <!-- ganti dengan domain -->
