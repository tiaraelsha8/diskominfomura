...
@section('content')
        ...
        <div class="album-grid">
            @foreach ($albums as $album)
                <div class="album-card" onclick="openModal({{ $album['id'] }})">
                    <img src="{{ asset('image/' . $album['cover']) }}" alt="{{ e($album['title']) }}">
    ...
    <div class="modal" id="imageModal" role="dialog" aria-modal="true" aria-labelledby="modalTitle">
        <div id="thumbContainer" class="thumb-container">
            @foreach ($albums as $album)
                <img src="{{ asset('image/' . $album['cover']) }}" alt="{{ $album['title'] }}"
    ...
    <script>
        ...
        function openModal(id) {
            ...
            modalImg.src = `{{ asset('image/') }}/${album.cover}`;
            modalImg.alt = album.title;

            modalImg.onerror = () => {
                console.warn("Fallback image used for modal:", album.cover);
