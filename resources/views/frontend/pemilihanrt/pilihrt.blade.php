...
@section('content')
    ...
    <div class="tentang-title-bg">
        <h1>Pemilihan RT di Kelurahan Beriwit</h1>
    </div>

    <section class="layanan-fullscreen" data-aos="fade-up">
        <h2 data-aos="fade-down" data-aos-delay="100">Pemilihan Ketua RT</h2>
        @if ($pemilihanrts->count())
            <div class="layanan-grid" data-aos="fade-up" data-aos-delay="200">
                @foreach ($pemilihanrts as $index => $item)
                    <a href="{{ $item->link_pemilihan }}" class="layanan-box" data-aos="zoom-in" target="_blank"
